...
$wp_customize->add_setting( 'complete[footer_color_id]', array(
	...
	'transport' => 'postMessage',
			...
			$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'footer_color_id', array(
				'label' => __('Footer Area Background Color','complete'),
				'section' => 'footercolors_section',
...
//FOOTER Widget Text Color
$wp_customize->add_setting( 'complete[footwdgtxtactive_color_id]', array(
	'type' => 'option',
	'default' => '#ffffff',
	'sanitize_callback' => 'sanitize_hex_color',
	'transport' => 'postMessage',
) );
		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'footwdgtxtactive_color_id', array(
			'label' => __('Footer Text Active and title border Color','complete'),
			'section' => 'footercolors_section',
			'settings' => 'complete[footwdgtxtactive_color_id]',
		) ) );
...
//----------------------Footer Columns 1----------------------------------
	$wp_customize->add_setting('complete[foot_cols1_title]', array(
		'type' => 'option',
		'default'	=> __('SKT Solution','complete'),
...
$wp_customize->add_setting('complete[foot_cols1_content]', array(
	'type' => 'option',
	'default' => '<p>Street 238,52 tempor <br>Donec ultricies mattis nulla, suscipit <br>risus tristique ut.</p>
...
$wp_customize->add_setting('complete[foot_cols4_content]', array(
	'type' => 'option',
	'default' => '<form class="newsletter-form"><input placeholder="Enter your email" type="email"><input value="GO" type="submit"></i></form>
