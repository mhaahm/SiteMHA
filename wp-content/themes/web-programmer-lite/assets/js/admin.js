...
//SLIDE CTA BUTTONS
jQuery("#complete-static_cta1_link, #complete-static_cta1_txt_style").appendTo(".tr_complete-static_cta1_text td");
jQuery("#complete-static_cta1_bg_color, #complete-static_cta1_txt_color").appendTo(".tr_complete-static_cta1_text td");

jQuery("#complete-static_cta2_link, #complete-static_cta2_txt_style").appendTo(".tr_complete-static_cta2_text td");
jQuery("#complete-static_cta2_bg_color, #complete-static_cta2_txt_color").appendTo(".tr_complete-static_cta2_text td");

jQuery(".tr_complete-static_cta1_link, .tr_complete-static_cta1_bg_color, .tr_complete-static_cta1_txt_color, .tr_complete-static_cta1_txt_style, .tr_complete-static_cta2_link, .tr_complete-static_cta2_bg_color, .tr_complete-static_cta2_txt_color, .tr_complete-static_cta2_txt_style").hide();
