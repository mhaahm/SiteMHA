 ...
 *
 * This is page template for page builder
 * It hides sidebar and makes page full width
 * You can also use full with for it but to make it
 * clear we are creating another page tempate
 *
